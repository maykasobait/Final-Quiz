...
@section('content')
    ...
    <div class="card card-primary card-outline">
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                Dedicated Information Technology student with experience in developing academic projects such as web and
                mobile applications. Eager to enhance my skills<br> in real-world environments and grow as an IT
                professional.<br><br>
                <hr>
                ...
                <p class="text-muted">
                    <span class="tag tag-danger">
                        <li>Develop a simple inventory system using MySql and PHP<br>
                    </span>
                    <span class="tag tag-success">
                        <li>Assisted in troubleshooting hardware and network issue <br>
                    </span>
                    <span class="tag tag-info">
                        <li>Maintaned and updated company website <br>
                    </span>
                                        ...
                                        <div class="row">
                                            <div class="col-7">
                                                ...
                                                <p class="text-muted text-sm"><b>About: </b> Web Designer / UX / Graphic
                                                    Artist / Coffee Lover/ Networker </p>
                                                <ul class="ml-4 mb-0 fa-ul text-muted">
                                                    <li class="small"><span class="fa-li"><i
                                                                class="fas fa-lg fa-building"></i></span> Address: Macabebe,
                                                        Pampanga</li>
                                                    <li class="small"><span class="fa-li"><i
                                                                class="fas fa-lg fa-phone"></i></span> Phone #:09963789513
                                                    </li>
                                                </ul>
                                            </div>
                                    ...
                                    <div class="card-body pt-0">
                                        <div class="row">
                                            <div class="col-7">
                                                ...
                                                <ul class="ml-4 mb-0 fa-ul text-muted">
                                                    <li class="small"><span class="fa-li"><i
                                                                class="fas fa-lg fa-building"></i></span> Address: San
                                                        Simon, Pampanga</li>
                                                    <li class="small"><span class="fa-li"><i
                                                                class="fas fa-lg fa-phone"></i></span> Phone #: 0935476552
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="col-5 text-center">
